...
/**
*
* Nome: Victor Antônio da Silva Lemos
* Curso: TSI
* Matrícula: 20212TSIIG0210
* 
*/
public class ContaBancaria {
	...
	public boolean equals(Object obj) {
		...
		return numeroConta == other.numeroConta && Double.doubleToLongBits(saldo) == Double.doubleToLongBits(other.saldo) && status == other.status && Objects.equals(titular, other.titular);
	}
}
